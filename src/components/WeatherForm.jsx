...
const WeatherForm = ({ onSearch }) => {
    ...
    return (
        <>
            <div className='container max-w-full md:max-w-[48rem] px-4 md:px-0 mx-auto'>
                <form onSubmit={handleSubmit} className='mt-5 w-full'>
                    <label htmlFor='search-btn' className='w-full flex justify-center'>
                        <div className='relative w-full'>
                            <svg className='absolute top-1/2 left-4 transform -translate-y-1/2 opacity-40 w-6 h-6'
                            ...
                            <input className='bg-[rgba(240,240,240,1)] w-full rounded-full pl-12 py-3.5 focus:outline-none focus:ring-2 
                                focus:ring-blue-500 focus:ring-opacity-50 shadow-md text-lg '
                                type="text"
